...
export const about: About[] = [
  {
    ...
    title: 'Ancient Forge',
    description:
      'From the ancient halls of Svartálfheim, the dwarf Brokk forged artifacts that shaped the fate of gods. His hammer struck true, crafting Mjölnir for Thor himself.',
    order: 1,
  },
  {
